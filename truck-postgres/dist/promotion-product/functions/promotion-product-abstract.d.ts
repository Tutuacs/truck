...
export declare abstract class PromotionProductAbstract {
    abstract createPromotionProduct(data: CreatePromotionProductDto): any;
    abstract findPromotionProduct(id: string): Promise<PromotionProduct>;
    abstract listPromotionProduct(): Promise<PromotionProduct[]>;
    abstract listByPromotion(id: string): Promise<PromotionProduct[]>;
