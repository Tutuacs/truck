...
const order_items_abstract_1 = require("./functions/order-items-abstract");
const order_items_filter_1 = require("./functions/order-items.filter");
...
exports.OrderItemsModule = OrderItemsModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [order_items_service_1.OrderItemsService,
            {
                provide: order_items_abstract_1.OrderItemsAbstract,
                useValue: order_items_filter_1.OrderItemsFunction,
            }
        ],
    })
], OrderItemsModule);
